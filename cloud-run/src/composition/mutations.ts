...
import { createCreateTradePlanFromWatchlist } from '@trading-cockpit/backend-core/application/trade-plan/create-trade-plan-from-watchlist';
...
import { createOpenPositionFromTradePlan } from '@trading-cockpit/backend-core/application/position/open-position-from-trade-plan';
import { createClosePosition } from '@trading-cockpit/backend-core/application/position/close-position';
import {
  createRecordDeposit,
