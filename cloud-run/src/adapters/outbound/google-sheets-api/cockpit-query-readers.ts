...
import type { DashboardRepositorySnapshot } from '@trading-cockpit/backend-core/ports/outbound/dashboard-repository';
import type { JournalReader } from '@trading-cockpit/backend-core/ports/outbound/journal-reader';
import type { MomentumRankingReader } from '@trading-cockpit/backend-core/ports/outbound/momentum-ranking-reader';
