...
import { createGetDashboard } from '../../src/core/application/dashboard/get-dashboard';
import type { DashboardRepositorySnapshot } from '../../src/ports/outbound/dashboard-repository';
