...
The existing `.clasp.json` keeps `rootDir` at the repository root. This lets clasp deploy the 19
...
- 19 hand-maintained legacy JavaScript files at the repository root;
- `MomentumScore.js`, still generated by its TypeScript pipeline;
- `build/Cockpit.js`;
- `appsscript.json`.
