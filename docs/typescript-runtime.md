...
TypeScript is the maintained source for migrated workflows. `apps/sheets/build/Cockpit.js` is generated and must
...
`apps/sheets/` root are temporary legacy modules listed in the architecture inventory.
