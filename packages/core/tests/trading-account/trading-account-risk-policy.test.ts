...
import { createTradingAccountRiskPolicy } from '@trading-cockpit/core/domain/trading-account-risk-policy';
import { calculateMaxRisk } from '@trading-cockpit/core/domain/trade-plan';
