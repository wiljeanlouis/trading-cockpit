...
} from '@trading-cockpit/core/application/watchlist/add-candidate-to-watchlist';
import type { WatchlistEntry, WatchlistIdentity } from '@trading-cockpit/core/domain/watchlist';
