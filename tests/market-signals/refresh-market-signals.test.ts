...
import type { MarketSignalBatch, MarketSignalFeed } from '../../src/core/domain/market-signal';
import type { MarketSignalSource } from '../../src/ports/outbound/market-signal-source';
