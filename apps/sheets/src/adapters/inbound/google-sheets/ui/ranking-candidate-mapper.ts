import type { AddCandidateToWatchlistCommand } from '@trading-cockpit/core/application/watchlist/add-candidate-to-watchlist';
import type { WatchlistSnapshotValue } from '@trading-cockpit/core/domain/watchlist';
