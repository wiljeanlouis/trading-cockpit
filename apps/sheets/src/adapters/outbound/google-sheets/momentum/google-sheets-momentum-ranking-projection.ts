import type { RankedMomentumCandidate } from '@trading-cockpit/core/domain/momentum';
import type { MomentumRankingProjection } from '@trading-cockpit/core/ports/outbound/momentum-ranking-projection';
import type { MomentumStrategySnapshot } from '@trading-cockpit/core/ports/outbound/momentum-signal-repository';
